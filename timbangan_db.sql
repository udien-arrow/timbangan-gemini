...
CREATE TABLE `transactions`  (
  ...
  `weight_1` decimal(10, 2) NOT NULL,
  `weight_1_manual` tinyint(1) NOT NULL DEFAULT 0,
  `weight_2` decimal(10, 2) NULL DEFAULT NULL,
  `weight_2_manual` tinyint(1) NULL DEFAULT 0,
  `gross_weight` decimal(10, 2) NULL DEFAULT NULL,
  `tare_weight` decimal(10, 2) NULL DEFAULT NULL,
